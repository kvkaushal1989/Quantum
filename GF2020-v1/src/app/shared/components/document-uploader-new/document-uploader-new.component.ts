...
@Component({
  selector: 'app-document-uploader-new',
  templateUrl: './document-uploader-new.component.html',
  styleUrls: ['./document-uploader-new.component.scss']
})
export class DocumentUploaderNewComponent implements OnInit {
