...
import { BasicDropdownPanelService, PanelDimensions } from './basic-dropdown-panel.service';

import { DropdownPosition } from './basic-auto-complete.component';
import { SelectOption } from './basic-auto-complete.types';
import { isDefined } from './value-utils';

const TOP_CSS_CLASS = 'basic-auto-complete-top';
const BOTTOM_CSS_CLASS = 'basic-auto-complete-bottom';
const SCROLL_SCHEDULER = typeof requestAnimationFrame !== 'undefined' ? animationFrameScheduler : asapScheduler;

@Component({
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    selector: 'basic-dropdown-panel',
    template: `
        <div *ngIf="headerTemplate" class="basic-dropdown-header">
            <ng-container [ngTemplateOutlet]="headerTemplate" [ngTemplateOutletContext]="{ searchTerm: filterValue }"></ng-container>
        </div>
        <div #scroll class="basic-dropdown-panel-items scroll-host">
            <div #padding [class.total-padding]="virtualScroll"></div>
            <div #content [class.scrollable-content]="virtualScroll && items.length">
                <ng-content></ng-content>
            </div>
        </div>
        <div *ngIf="footerTemplate" class="basic-dropdown-footer">
            <ng-container [ngTemplateOutlet]="footerTemplate" [ngTemplateOutletContext]="{ searchTerm: filterValue }"></ng-container>
        </div>
    `
})
export class BasicDropdownPanelComponent implements OnInit, OnChanges, OnDestroy {

    @Input() items: SelectOption[] = [];
    @Input() markedItem: SelectOption;
    ...
    constructor(
        ...
        private _panelService: BasicDropdownPanelService,
    ...
    scrollTo(option: SelectOption, startFromOption = false) {
        if (!option) {
            return;
        }
    ...
    private _onItemsChange(items: SelectOption[], firstChange: boolean) {
        this.items = items || [];
