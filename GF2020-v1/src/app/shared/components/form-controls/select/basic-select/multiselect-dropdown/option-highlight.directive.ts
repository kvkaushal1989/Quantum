...
import { Directive, Input, ElementRef, Renderer2, OnChanges, AfterViewInit } from '@angular/core';

@Directive({
  selector: '[basicOptionHighlight]'
})
export class OptionHighlightDirective implements OnChanges, AfterViewInit {
  @Input('basicOptionHighlight') term: string;
