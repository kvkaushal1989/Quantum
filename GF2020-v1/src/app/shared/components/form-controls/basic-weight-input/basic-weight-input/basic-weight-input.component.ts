...
@Component({
  selector: 'app-basic-weight-input',
  templateUrl: './basic-weight-input.component.html',
  styleUrls: ['./basic-weight-input.component.scss'],
  providers: [{
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => BasicWeightInputComponent),
      multi: true
    },
    NumberFormatePipe
  ]
})
export class BasicWeightInputComponent implements OnInit, ControlValueAccessor  {
